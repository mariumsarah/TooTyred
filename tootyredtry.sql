...
/*!40101 SET @OLD_COLLATION_CONNECTION=@@COLLATION_CONNECTION */;
 DROP DATABASE mariumsarah$tootyred;
 CREATE DATABASE mariumsarah$tootyred;
 USE mariumsarah$tootyred;
 SET NAMES utf8 ;
...
CREATE TABLE bike_future_points(
bik_id INTEGER(11) NOT NULL,
atStation INTEGER(11) NOT NULL,
atDateTime TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
untilDateTime TIMESTAMP,
CONSTRAINT fk_bik_id FOREIGN KEY (bik_id) REFERENCES bike(bike_id),
CONSTRAINT fk_station FOREIGN KEY (atStation) REFERENCES station(station_id)
)ENGINE = INNODB;

INSERT INTO bike_future_points (bik_id,atStation) VALUES
(1,1),
(2,1),
(3,1),
(4,1),
